  ...
  return (
    <div ref={ref} className="relative">
      ...
      <motion.section
        ...
        className="relative flex flex-col items-start px-12 py-24 md:flex-row md:items-center md:justify-between bg-opacity-70 blur-0"
      >
        <div className="md:w-1/2">
          <h1 className="text-[10vw] md:text-[6vw] font-extrabold leading-none uppercase">
            Web Developer
          </h1>
          <p className="text-lg md:text-2xl mt-4 max-w-lg font-extrabold">
